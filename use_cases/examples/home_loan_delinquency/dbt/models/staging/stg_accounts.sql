...
-- A table containing all the accounts across the portfolio. Includes
-- Current Accounts and Loans.
--
-- This model selects the harmonised account information including current
-- accounts and loans, joins it together with provisions data, and calculates
-- the delinquency band. To inspect the definition of the fields, generate
