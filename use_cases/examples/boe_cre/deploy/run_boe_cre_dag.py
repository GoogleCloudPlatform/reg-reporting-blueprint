...
def boe_cre():
    ...
    generate_data_job = ComposerPodOperator(
        ...
        name='generate-data',
        image='{{ params.repo }}/boe-cre-data-generator:{{ params.tag }}',
        arguments=[
    ...
    run_cre_report = DBTComposerPodOperator(
        task_id='transform-data',
        name='transform-data',
        image='{{ params.repo }}/boe-cre-dbt:{{ params.tag }}',
        cmds=[
            '/bin/bash',
            '-xc',
            '&&'.join([
    ...
    test_cre_report = DBTComposerPodOperator(
